...
This document describes the Rhodium Standard Repository (RSR) compliance status for *vext*.
...
|Primary language is Tier 1/2 |✓ |python
...
* Python permitted in salt/ directories only
